...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "t1100", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "T1100Pkg/t1100.dsc", "Platform Hardcoded")
    ...
    def PlatformBuildBootImage (self):
        ...
        dtb = os.path.join(blob_dir, "mt6771-fplus-t1100.dtb")
